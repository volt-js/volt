 ...
 * under test is the checker and not the framework's own types: a fixture that
 * resolved the real package would only pass once that package had been built,
 * and would fail for reasons that have nothing to do with a template.
 */
