...
export default defineConfig({
  // `start: true` is the whole of the wiring. It gives this project a request
  ...
  // one decision. Deleting `start` puts both back: the project becomes an
  // ordinary client-rendered application and nothing else has to change.
